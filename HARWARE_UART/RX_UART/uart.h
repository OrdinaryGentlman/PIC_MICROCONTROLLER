...
#define TX_MODE     0x10   // UART in TX mode only
#define RX_MODE     0x20   // UART in RX mode only
#define FULL_DUPLEX 0x40   // UART in TX and RX mode (Read and Write at the same time), ONLY AVAIALBLE FOR ASYNCHRONOUS MODE.
