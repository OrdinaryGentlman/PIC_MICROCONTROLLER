...
void uart_write(unsigned char data) {
    ...
    LATBbits.LATB0 = 0;
    _delay((unsigned long)(((10000000 / 9600))*(8000000/4000000.0)));


    for (i = 0; i < 8; i++) {
        LATBbits.LATB0 = (data >> i) & 0x01;
        _delay((unsigned long)(((10000000 / 9600))*(8000000/4000000.0)));
    }
...
unsigned char uart_read() {
    ...
    _delay((unsigned long)(((10000000 / 9600) / 2)*(8000000/4000000.0)));
