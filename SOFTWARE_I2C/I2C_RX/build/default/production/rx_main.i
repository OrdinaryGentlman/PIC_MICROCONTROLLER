...
void i2c_wait_for_start(void) {
    while (PORTBbits.RB4 && PORTBbits.RB1);
}

void i2c_wait_for_restart(void) {

    while (!(PORTBbits.RB4 == 1 && PORTBbits.RB1 == 1));
    while (PORTBbits.RB4 == 1 && PORTBbits.RB1 == 1);
    while (!(PORTBbits.RB4 == 1 && PORTBbits.RB1 == 0));
    while (PORTBbits.RB4 == 1 && PORTBbits.RB1 == 0);
}

void i2c_wait_for_stop(void) {
    while (!(PORTBbits.RB1 && PORTBbits.RB4));
    TRISB4 = TRISB1 = 1;
}
